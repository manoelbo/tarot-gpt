...
function drawTarotCards() {
    const majorArcana = [
        ...
        { name: "A Sacerdotisa", image: `${FIREBASE_URL}/a02.jpg` },
        { name: "A Imperatriz", image: `${FIREBASE_URL}/a03.jpg` },
        { name: "O Imperador", image: `${FIREBASE_URL}/a04.jpg` },
        { name: "O Hierofante", image: `${FIREBASE_URL}/a05.jpg` },
        { name: "Os Enamorados", image: `${FIREBASE_URL}/a06.jpg` },
        { name: "O Carro", image: `${FIREBASE_URL}/a07.jpg` },
        { name: "A Força", image: `${FIREBASE_URL}/a08.jpg` },
        { name: "O Eremita", image: `${FIREBASE_URL}/a09.jpg` },
        { name: "A Roda da Fortuna", image: `${FIREBASE_URL}/a10.jpg` },
        { name: "A Justiça", image: `${FIREBASE_URL}/a11.jpg` },
        { name: "O Pendurado", image: `${FIREBASE_URL}/a12.jpg` },
        { name: "A Morte", image: `${FIREBASE_URL}/a13.jpg` },
        { name: "A Temperança", image: `${FIREBASE_URL}/a14.jpg` },
